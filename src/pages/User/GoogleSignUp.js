...
function GoogleSignUp() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post("/user/googleregister", {
        firstName,
        lastName,
        email,
        password,
    ...
    >
      <div className="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
        <div className="flex justify-center mx-auto">
          <img className="w-20 h-30" src="" alt="" />
          <div className="mt-8">
        ...
        <form className="mt-6">
            ...
            <div className="w-1/2 pr-2">
              ...
              <input
                ...
                className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border
                  rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600
          ...
          <div className="mt-6">
            <button
              className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-
                  white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg
                  hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-
                  opacity-50"
              onClick={handleLogin}
            >
              Sign Up
